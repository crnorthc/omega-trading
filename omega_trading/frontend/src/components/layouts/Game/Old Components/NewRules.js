   ...
   <div>
    <div className='first-rule'>
     ...
     <div className='parameter'>
      ...
      <button onClick={() => setPublic(!Public)} className='ruleButton'>
    ...
    <div className='sub-rules'>
     ...
     <div className='rules-row'>
      ...
      <div className='parameter'>
       {bet == "yes" ? (
        <button onClick={() => Show(true)} className='ruleButton'>
         Define
        </button>
       ) : null}
      </div>
    ...
    <div className='fr jc-c mmy'>
     <button onClick={() => create()} className='editButton'>
      {props.creating_game ? <ButtonLoader /> : "Create"}
     </button>
    </div>
   </div>
  );
