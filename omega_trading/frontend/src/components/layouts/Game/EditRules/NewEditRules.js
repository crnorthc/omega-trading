...
function NewEditRules(props) {
 ...
 const { days, changeDays, hours, changeHours, mins, changeMins } = Duration(
  props.game
 );
   ...
   <div className='fr'>
    ...
    <div className='time-choice'>
     <select
      ...
      value={dateHour}
      onChange={(e) => changeDateHour(e.target.value)}
     >
     ...
     <select
      className='time-input'
      value={dateMin}
      onChange={(e) => changeDateMin(e.target.value)}
     >
      {choices(["00", "15", "30", "45"])}
     </select>
     <select
   ...
   <div className='fr ai-c jc-c'>
    ...
    <div className='fc ai-e'>
     ...
     <select
      className='min-input'
      placeholder={mins}
      onChange={(e) => changeMins(e.target.value)}
     >
      {minutes.map((min) => {
       return (
    ...
    <div className='rules-row'>
     <div className='parameter'>
      ...
      <div className='yesnoCont fr jc-s'>
       <button
        style={endType == "date" ? selected : not}
       ...
       <button
        style={endType == "duration" ? selected : not}
        onClick={() => setEndType("duration")}
        className='no'
       >
        Timer
       </button>
