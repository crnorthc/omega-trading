    ...
    return (
        <>
            <div className="z-10 absolute top-16 right-0 bottom-3/4 sm:bottom-2/3 left-0 flex items-end sm:items-center justify-center">
                <h1 className="font-mono font-medium text-white text-center text-5xl sm:text-6xl  ">Short Game</h1>
            </div>
...
cursor-pointer select-none relative py-2 pl-10 pr-4`
                                                    ...
                                                    >
                                                        {({ selected, active }) => (
                                                            <>
                                                                <span className={`${selected ? 'font-medium' : 'font-normal'} block truncate`}>{theHour.insert}</span>
                                                                {selected ? (
                                                                    <span
                                                                        className={`${active ? 'text-amber-600' : 'text-amber-600'}
absolute inset-y-0 left-0 flex items-center pl-3`}
...
export default connect(mapStateToProps, { create })(ShortGame);
