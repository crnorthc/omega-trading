...
absolute inset-y-0 left-0 flex items-center pl-3`}
        ...
        <div className='col-span-12 sm:col-span-6'>
         <Tab.Group>
          <label
           className='block text-lg font-medium text-white pb-2'
           htmlFor=''
          >
           Duration
          </label>
...
absolute inset-y-0 left-0 flex items-center pl-3`}
      ...
      <div className='flex items-center justify-center'>
       <button
        onClick={() => create()}
        className='block bg-yellow-500 text-gray-900 text-xl sm:text-2xl py-4 px-7 mt-10 mb-32 rounded-lg shadow-md'
       >
        Create Game
       </button>
      </div>
