...
export const hideResults = (period, friends = false, username = false) => dispatch => {
    dispatch({
        type: HIDE_RESULTS
    })
}

export const loadPortfolio = (period, friends = false, username) => dispatch => {
    const config = {
        headers: {
            "Content-Type": "application/json",
    ...
    axios.post('/users/portfolio', body, config)
        .then(res => {
            if (res.data.Error) {
                console.log("ooops")
            }
...
export const acceptInvite = (username, accepted, unadd) => dispatch => {
    ...
    axios.post('/users/accept', body, config)
        .then(res => {
            if (res.data.Error) {
                console.log("oops")
            }
...
export const sendInvite = (username, unsend) => dispatch => {
    ...
    axios.post('/users/invite', body, config)
        .then(res => {
            if (res.data.Error) {
                console.log("oops")
            }
...
export const loadUsers = (username, friends) => dispatch => {
    ...
    axios.post('/users/search-user', body, config)
        .then(res => {
            if (res.data.Error) {
                console.log("oops")
            }
